...
namespace ZeroRpc.Net
{
    ...
    public static class Config
    {
        ...
        ///     Thus the developer who wishes to change the equality comparer must accomodate for the message ids being of
        ///     different types.
        /// </remarks>
        ...
        ///     By default, zerorpc-dotnet uses <see cref="Net.UuidGenerator.NextUuidBytes" />; that is the UUID will be encoded as
        ///     a byte array.
        /// </summary>
        /// <remarks>
        ///     While zerorpc does allow any type to be a valid ID, zerorpc-dotnet provides two main versions available via
        ///     <see cref="ZeroRpc.Net.UuidGenerator" />:
